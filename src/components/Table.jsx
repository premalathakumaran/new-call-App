...
// // // Deduplicate phone numbers in each item and include the formatted number
// // const deduplicatePhones = (phones) => {
// //   console.log("deduplicate triggered",phones);
// //   return Array.from(new Set(phones.map((phone) => phone.mobileNumber)))
// //     .map((mobileNumber) => 
...
//   {/* Display group code or 'N/A' if not available */}
//   {item.groupCode || 'N/A'}

//   {/* Regenerate button */}
//   <button
//     className="ml-2 bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600"
//     onClick={() => handleRegenerate(item.groupId)} // Adjust the function as needed
//   >
//     Regenerate
//   </button>
// </td>
